...
%
        ...
        % % Scenario 1 : demand peak with 3 car
    and
    1 PT routes %
        -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- %
...
% factor < 1 to scale down the demand level and decrease the trip -
               based solver computation time DemSC1 end
...
% 'demprorata', 'demfifo',
    'equiproba' or 'endogenous' Simulation.DivergeModel = 'queuedyn';
% 'maxdem', 'decrdem' or 'queuedyn' Simulation.TripbasedSimuFactor = 0.7;
% factor < 1 to scale down the demand level and decrease the trip -
               based solver computation time DemSC1 end

                   % % Scenario 2 : congestion with 2 car and
    1 PT routes,
    bottleneck at R3 exit %
        -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- %
...
% 'maxdem', 'decrdem' or 'queuedyn' Simulation.TripbasedSimuFactor = 1.0;
% factor < 1 to scale down the demand level and decrease the trip -
               based solver computation time DemSC2 end

                   % % Scenario 3 : congestion with 3 car routes,
    bottleneck at R3 exit %
        -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- %
        Test inspired by the scenario SC1 from the Braess network with 1 mode
...
% 'demprorata', 'demfifo',
    'equiproba' or 'endogenous' Simulation.DivergeModel = 'maxdem';
% 'maxdem', 'decrdem' or 'queuedyn' Simulation.TripbasedSimuFactor = 0.4;
% factor < 1 to scale down the demand level and decrease the trip -
