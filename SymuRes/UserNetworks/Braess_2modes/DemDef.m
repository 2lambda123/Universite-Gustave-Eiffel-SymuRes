...
%% Scenario 1:
demand peak with 3 car and 1 PT routes
%--------------------------------------------------------------------------
...
% factor < 1 to scale down the demand level and decrease the trip-based solver computation time
DemSC1
end
...
if strcmp(Simulation.Name(1:4),'SC14')
    Simulation.MergeModel = 'demprorata';
% 'demprorata', 'demfifo', 'equiproba' or 'endogenous'
Simulation.DivergeModel = 'queuedyn';
% 'maxdem', 'decrdem' or 'queuedyn'
...
%% Scenario 2:
congestion with 2 car and 1 PT routes, bottleneck at R3 exit
%--------------------------------------------------------------------------
...
%% Scenario 3:
congestion with 3 car routes, bottleneck at R3 exit
%--------------------------------------------------------------------------
% Test inspired by the scenario SC1 from the Braess network with 1 mode
...
Simulation.DivergeModel = 'maxdem';
% 'maxdem', 'decrdem' or 'queuedyn'
Simulation.TripbasedSimuFactor = 0.4;
% factor < 1 to scale down the demand level and decrease the trip-based solver computation time
DemSC3
end
